...
const SearchBox = (props: Props) => {
    ...
    return <div
        className={`grow text-sm font-mono lg:ml-4 lg:mr-8 w-96 flex flex-row items-center justify-start bg-gray-50 p-1 hover:cursor-text rounded-lg ${props.className || ""}`}
        onClick={() => {
