          ...
          >
            {row.map((cell, cellNr) => (
              <>
                ...
                <td
                  className={`break-all pt-0 md:ps-4 md:last:pe-4 md:py-3 text-left xs:text-left md:last:text-right last:pb-4 ${props.additionalClassNames && (props.additionalClassNames[cellNr] || "")}`}
                >
                  {cell}
                </td>
              </>
